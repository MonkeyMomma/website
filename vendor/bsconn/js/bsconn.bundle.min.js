! function(t, e) {
    ...
    p.fn[Ui] = Zi._jQueryInterface, p.fn[Ui].Constructor = Zi, p.fn[Ui].noConflict = function() {
        ...
        function() {
            if ("undefined" == typeof p) throw new TypeError("This JavaScript requires jQuery. jQuery must be included before JavaScript.");
            var t = p.fn.jquery.split(" ")[0].split(".");
            if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || 4 <= t[0]) throw new Error("This JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
